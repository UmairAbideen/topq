                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="date" name="manufacturing_date" class="form-control"
                                            value="{{ $closure->manufacturing_date }}">
                                    </div>
                                </div>
