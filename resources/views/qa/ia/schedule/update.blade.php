                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        ...
                        <div class="d-flex justify-content-end pe-0 pt-4">
                            <a href="{{ route('qa.ia.schedule.view') }}" class="btn btn-info" role="button" aria-pressed="true">Go
                                Back</a>
                        </div>
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" name="internal_auditor1" class="form-control"
                                            value="{{ $schedule->internal_auditor1 }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" name="internal_auditor2" class="form-control"
                                            value="{{ $schedule->internal_auditor2 }}">
                                    </div>
                                </div>
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" name="time1" placeholder="00:00am - 00:00pm"
                                            class="form-control" value="{{ $schedule->time1 }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" name="time2" placeholder="00:00am - 00:00pm"
                                            class="form-control" value="{{ $schedule->time2 }}">
                                    </div>
                                </div>
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" name="time3" placeholder="00:00am - 00:00pm"
                                            class="form-control" value="{{ $schedule->time3 }}">
                                    </div>
                                </div>
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
