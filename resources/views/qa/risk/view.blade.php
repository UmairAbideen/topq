                                ...
                                <tbody>
                                    @foreach ($risks as $risk)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">{{ $risk->detectability_after }}</td>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if ($risk->verified_by == '')
                                                    <a href="{{ route('qa.risk.verify', $risk->id) }}"
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if ($risk->approved_by == '')
                                                    <a href="{{ route('qa.risk.approve', $risk->id) }}"
                                                        class="btn bg-gradient-info btn-sm mb-0 ms-1 me-1 " role="button"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Do you want to remove the Risk Assessment?</p>
                                                                    </div>
