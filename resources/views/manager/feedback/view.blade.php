            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="d-flex justify-content-end pe-3 pt-4">
                        <a href="{{ route('manager.feedback.form') }}" class="btn bg-gradient-info" role="button"
                            aria-pressed="true">
                            View Form</a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <a href="{{ route('manager.feedback.download', $feedback->id) }}"
                                                            class="btn bg-gradient-success btn-sm mb-0 ms-1 me-1 "
                                                            role="button" aria-pressed="true">Download</a>
                                                    </div>
                                                    <div>
                                                        <a href="{{ route('manager.feedback.print', $feedback->id) }}"
                                                            target="_blank"
