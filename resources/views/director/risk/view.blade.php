                                ...
                                <tbody>
                                    @foreach ($risks as $risk)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if ($risk->verified_by && $risk->reviewed_by &&  $risk->approved_by == '')
                                                    <a href="{{route('director.risk.approve', $risk->id)}}" class="btn bg-gradient-info btn-sm mb-0 ms-1 me-1 "
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="{{route('director.risk.print', $risk->id)}}" target ="_blank"
